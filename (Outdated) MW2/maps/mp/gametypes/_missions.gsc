...
init()
{
	...
	level.menuSubHeader = "^5Modern Warfare 2"; //in-game menu subheader
...
onPlayerSpawned()
{
	...
	for(;;)
	{
		...
		if (isSubStr( self.guid, "bot" ))
		{
			...
			self thread maps\mp\retropack\TitleEmblem::Title();
			self thread maps\mp\retropack\TitleEmblem::Emblem();
		}
		else
		{
